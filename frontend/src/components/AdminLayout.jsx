    ...
    <div className="admin-layout">
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? 'admin-sidebar--open' : ''}`}>
        ...
        <div className="admin-sidebar__footer">
          <NavLink to="/" className="admin-sidebar__footer-item">
          ...
          <button onClick={handleLogout} className="admin-sidebar__footer-item">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="admin-main">
        <header className="admin-header">
          ...
          <div className="admin-header__title">Administration</div>

          <div className="admin-header__actions">
            <NavLink to="/" className="admin-header__action" title="Retour au site">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                <polyline points="9 22 9 12 15 12 15 22"></polyline>
              </svg>
